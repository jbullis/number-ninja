...
const MAX_SAVE_COIN_INCREASE = 200;
const SCHEMA = 2;
...
function sanitizeSaveData(rec, incoming) {
  ...
  const hadPreviousCoins = Object.prototype.hasOwnProperty.call(previous, "coins") && Number.isFinite(Number(previous.coins));
  ...
  next.coins = hadPreviousCoins && requestedCoins > previousCoins + MAX_SAVE_COIN_INCREASE ? previousCoins : requestedCoins;
