...
async function setup(){
  ...
  KV.store.set(activityKey("ReportKid"), JSON.stringify({
    version:1,
    attempts,
    daily:{"2026-08-08":{attempts:3,correct:1,help:2,activeSeconds:600,skills:["4.multiMultiply"]},"2026-08-09":{attempts:5,correct:2,help:1,activeSeconds:900,skills:["4.multiMultiply","4.longDivision"]}},
    skills:{},
  ...
  rec.controls.assignments = [{id:"asg1",title:"Multiply practice",status:"active",source:"parent",skillIds:["4.multiMultiply"],groupIds:[],targetType:"problems",target:10,dueDate:"2026-08-01",schedule:"once",weekdays:[],reward:{coins:8},occurrences:{currentOccurrenceDate:"2026-08-09",attempted:1,correct:0,completed:false}}];
